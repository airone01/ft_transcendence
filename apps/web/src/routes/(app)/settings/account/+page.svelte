  ...
  <div class="space-y-4">
    ...
    >
        ...
        <FormField {form} name="oldPassword">
          <FormControl>
            {#snippet children({ props })}
              <FormLabel
                >{m.settings_page_account_label_current_password()}</FormLabel
              >
              <Input
                {...props}
                type="password"
      ...
      <FormField {form} name="newPassword">
        <FormControl>
          {#snippet children({ props })}
            <FormLabel>{m.settings_page_account_label_new_password()}</FormLabel
            >
            <Input
              {...props}
              type="password"
      ...
      <FormField {form} name="confirmPassword">
        <FormControl>
          {#snippet children({ props })}
            <FormLabel
              >{m.settings_page_account_label_confirm_password()}</FormLabel
            >
            <Input
              {...props}
              type="password"
